var M;
var lista: Array<Device> = [];
var ulDisp;
var iDispositivo;
//var cargaDispositivo;
function cargarValor(valor:Number)  {
  var leerDato;
  switch (valor) {
    case 1:
      leerDato = "Lampara";
...
class Main implements EventListenerObject, HttpResponse {
  ...
  dispositivo: Array<Device> = new Array();
  
  constructor() {
    ulDisp = document.getElementById("listaDisp");
    //alert(JSON.stringify(obj));
  }
  blanquear(element: any) {
    element.innerHTML = "";
  }
  ...
  enviarDispositivo(dato: Device, valor: number) {
  ...
  handleEvent(event) {
    ...
    if (elemento.id.startsWith("btd_")) { 
      ...
      //Se consulta por la opcion de buscar y editar, se edita por la opcion de elemento id que la busquera empieza por bte_
        ...
        var iDescripcion = <HTMLInputElement>(document.getElementById("iDescripcion"));
        var iTipoDispositivo = <HTMLInputElement>(document.getElementById("iTipoDispositivo"));
        var iEstado = <HTMLInputElement>document.getElementById("iswitch");
        var iTipo = <HTMLInputElement>document.getElementById("iTipo");
    ...
    // y cargar la tabla 
      ...
      var iTipoDispositivo2 = <HTMLInputElement>(document.getElementById("iTipoDispositivo2"));
...
window.addEventListener("load", () => {
  ...
  var btnBuscar: HTMLElement = document.getElementById("btnBuscar");
